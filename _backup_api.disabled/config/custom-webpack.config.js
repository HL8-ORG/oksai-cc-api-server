 ...
 * Handles:
 * - Copying built @oksai/* packages to dist/apps/api/node_modules
...
const targetNodeModulesDir = path.resolve(__dirname, '../../../dist/apps/api/node_modules/@oksai');
	...
	(config) => {
		...
		config.watchOptions = {
			ignored: [
				...
				// webpack watches it automatically because @oksai/core resolves to source via tsconfig-paths
			],
