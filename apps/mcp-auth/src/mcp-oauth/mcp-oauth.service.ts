...
import { OAuth2AuthorizationServer, UserInfo } from '@oksai/auth';
import { OAuthUserService } from '../user/oauth-user.service';
import { IUser } from '@oksai/contracts';
 ...
 * MCP OAuth Service
 *
 * This service wires the generic OAuth2AuthorizationServer from @oksai/auth
 */
@Injectable()
