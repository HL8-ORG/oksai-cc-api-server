	...
	template: `
		<nb-tabset style="padding: 1rem;">
			<nb-tab
				class="custom-tab"
				style="padding: 1rem;"
				tabTitle="{{ 'CANDIDATES_PAGE.EDIT_CANDIDATE.EDUCATION' | translate }}"
			>
				<ga-edit-candidate-education></ga-edit-candidate-education>
			</nb-tab>
			<nb-tab style="padding: 1rem;" tabTitle="{{ 'CANDIDATES_PAGE.EDIT_CANDIDATE.EXPERIENCE' | translate }}">
				<ga-edit-candidate-experience-form></ga-edit-candidate-experience-form>
			</nb-tab>
			<nb-tab style="padding: 1rem;" tabTitle="{{ 'CANDIDATES_PAGE.EDIT_CANDIDATE.SKILLS' | translate }}">
