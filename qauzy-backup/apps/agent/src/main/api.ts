...
export class ApiService {
	...
	async getTasksStatuses({ tenantId, organizationId }: { tenantId: string; organizationId: string }): Promise<void> {
	...
	async request(
		...
		const requestOptions = options.method === 'GET' ? { method: options.method, headers } : { ...options, headers };
