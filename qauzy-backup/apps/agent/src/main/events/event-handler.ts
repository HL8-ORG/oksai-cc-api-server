...
import { getAuthConfig, delaySync, TAuthConfig, updateAgentSetting, getAppSetting, getInitialConfig } from '../util';
import { DesktopUpdater, AppError, TranslateService, DesktopDialog } from '@gauzy/desktop-lib';
...
export default class EventHandler {
	...
	async exitDialog() {
		...
		dialog.options.buttons = [TranslateService.instant('OK')];
		await dialog.show();
	}
