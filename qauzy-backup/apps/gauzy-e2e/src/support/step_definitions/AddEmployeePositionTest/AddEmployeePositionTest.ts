...
And('User can add data for new position', () => {
	addEmployeePositionPage.enterNewPositionData(AddEmployeePositionPageData.deleteThisPosition);
});
...
Then('User can verify that position was deleted', () => {
	addEmployeePositionPage.verifyElementIsDeleted(AddEmployeePositionPageData.deleteThisPosition);
});
