...
And('User can select language from dropdown options', () => {
	accountingTemplatesPage.selectLanguageFromDropdownOptions(AccountingTemplatesPageData.english);
});
...
And('User can select Invoice dropdown option', () => {
	accountingTemplatesPage.selectTemplateFromDropdownOptions(AccountingTemplatesPageData.invoiceOpt);
});
...
And('User can verify invoice template header', () => {
	accountingTemplatesPage.verifyLeftTableData(AccountingTemplatesPageData.invoice);
});

And('User can verify sender column', () => {
	accountingTemplatesPage.verifyLeftTableData(AccountingTemplatesPageData.from);
});
...
And('User can verify invoice number column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.invoiceNumber);
});

And('User can verify invoice date column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.invoiceDate);
});

And('User can verify invoice due date column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.dueDate);
});
...
And('User can select Estimate dropdown option', () => {
	accountingTemplatesPage.selectTemplateFromDropdownOptions(AccountingTemplatesPageData.estimateOpt);
});
...
And('User can verify estimate template header', () => {
	accountingTemplatesPage.verifyLeftTableData(AccountingTemplatesPageData.estimate);
});
...
And('User can verify estimate number column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.estimateNumber);
});

And('User can verify estimate date column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.estimateDate);
});
...
And('User can select Receipt dropdown option', () => {
	accountingTemplatesPage.selectTemplateFromDropdownOptions(AccountingTemplatesPageData.receiptOpt);
});
...
And('User can verify receipt template header', () => {
	accountingTemplatesPage.verifyLeftTableData(AccountingTemplatesPageData.receipt);
});

And('User can verify bill to column', () => {
	accountingTemplatesPage.verifyLeftTableData(AccountingTemplatesPageData.billTo);
});

And('User can verify receipt number column', () => {
	accountingTemplatesPage.verifyReceiptNumberAndPaymentData(AccountingTemplatesPageData.receiptNumber);
});

And('User can verify receipt payment date column', () => {
	accountingTemplatesPage.verifyRightTableData(AccountingTemplatesPageData.paymentDate);
});

And('User can verify receipt payment method column', () => {
	accountingTemplatesPage.verifyReceiptNumberAndPaymentData(AccountingTemplatesPageData.paymentMethod);
});
