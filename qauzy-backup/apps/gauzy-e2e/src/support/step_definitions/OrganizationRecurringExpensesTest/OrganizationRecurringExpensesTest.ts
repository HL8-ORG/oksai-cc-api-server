...
Then('User can select expense from dropdown options', () => {
	organizationRecurringExpensesPage.selectExpenseOptionDropdown(OrganizationRecurringExpensesPageData.defaultExpense);
});
...
And('User can enter value for expense', () => {
	organizationRecurringExpensesPage.enterExpenseValueInputData(OrganizationRecurringExpensesPageData.defaultValue);
});
...
Then('User can select new expense from dropdown options', () => {
	organizationRecurringExpensesPage.selectExpenseOptionDropdown(OrganizationRecurringExpensesPageData.editExpense);
});
