export const ImportExportPage = {
	...
	importBtnCss: 'nb-card-body > div.row > div[class="col-sm-12 col-md-12 m-2"] > button[status="success"]',
	exportBtnCss: 'nb-card-body > div.row > div[class="col-sm-12 col-md-12 m-2"] > button[status="info"]',
	migrateBtnCss: 'nb-card-body > div.row > div[class="col-sm-12 col-md-12 m-2"] > button[status="warning"]',
	downloadTemplatesButtonCss:
		'nb-card-body > div.row > div[class="col-sm-12 col-md-12 m-2"] > button[status="basic"]',
	passwordInputCss:
		'div[class="nb-form-control-container nb-form-field-control-with-suffix"] > input[type="password"]',
	...
	verifyUploadStatusCss:
		'nb-icon > svg[class="eva eva-checkmark-circle-outline"] > g[data-name="Layer 2"] > g[data-name="checkmark-circle"]'
};
