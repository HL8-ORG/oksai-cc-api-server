export const AccountingTemplatesPage = {
	leftTableDataCss: 'table[role="presentation"] > tbody > tr > td[align="left"] > div',
	rightTableDataCss: 'table[role="presentation"] > tbody > tr > td[align="left"] > div > div > span',
	...
	saveBtnCss: 'div[class="col-2 d-flex justify-content-end"] > button[status="success"]'
};
