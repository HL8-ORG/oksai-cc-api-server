...
export const selectLanguageFromDropdownOptions = (language) => {
	clickElementByText(AccountingTemplatesPage.languageDropdownOptionCss, language);
};
...
export const selectTemplateFromDropdownOptions = (template) => {
	clickElementByText(AccountingTemplatesPage.templateDropdownOptionCss, template);
};
...
export const verifyReceiptNumberAndPaymentData = (text) => {
	verifyText(AccountingTemplatesPage.receiptNumberAndPaymentMethodDataCss, text);
};
