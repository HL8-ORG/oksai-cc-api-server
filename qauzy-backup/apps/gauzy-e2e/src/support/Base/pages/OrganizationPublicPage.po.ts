...
export const selectOrganization = (name: string) => {
	clickElementByText(OrganizationPublicPage.organizationDropdownOptionsCss, name);
};
...
export const minimumProjectSizeDropdownVisible = () => {
	verifyElementIsVisible(OrganizationPublicPage.minimumProjectSizeDropdownCss);
};
...
export const selectMinimumProjectSizeDropdownOption = (text: string) => {
	clickByText(OrganizationPublicPage.minimumProjectSizeDropdownOptionsCss, text);
};
