...
export const expenseDropdownVisible = () => {
	verifyElementIsVisible(OrganizationRecurringExpensesPage.expenseDropdownCss);
};
...
export const selectExpenseOptionDropdown = (text) => {
	clickElementByText(OrganizationRecurringExpensesPage.dropdownOptionCss, text);
};
...
export const deleteOnlyThisRadioButtonVisible = () => {
	verifyElementIsVisible(OrganizationRecurringExpensesPage.deleteOnlyThisRadioButtonCss);
};
...
export const confirmDeleteButtonVisible = () => {
	verifyElementIsVisible(OrganizationRecurringExpensesPage.confirmDeleteExpenseButtonCss);
};

export const clickConfirmDeleteButton = () => {
	clickButton(OrganizationRecurringExpensesPage.confirmDeleteExpenseButtonCss);
};
