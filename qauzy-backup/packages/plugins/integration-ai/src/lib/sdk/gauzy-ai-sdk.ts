	...
	employeeJobPosts: {
		...
		edges: Array<{
			...
			node: {
				...
				employee?: { __typename?: 'Employee'; id?: string | null; externalEmployeeId?: string | null } | null;
				jobPost?: {
					__typename?: 'JobPost';
					id?: string | null;
					providerCode: string;
...
export type EmployeeJobPostsByEmployeeIdJobPostIdQuery = {
	...
	employeeJobPosts: {
		...
		edges: Array<{
			__typename?: 'EmployeeJobPostEdge';
			node: { __typename?: 'EmployeeJobPost'; id?: string | null; isActive: boolean; isArchived: boolean };
		}>;
	};
};
...
export type EmployeeByExternalEmployeeIdQuery = {
	...
	employees: {
		...
		edges: Array<{
			__typename?: 'EmployeeEdge';
			node: { __typename?: 'Employee'; id?: string | null; externalEmployeeId?: string | null };
		}>;
	};
};
...
export type DeleteManyUpworkJobsSearchCriteriaMutation = {
	__typename?: 'Mutation';
	deleteManyUpworkJobsSearchCriteria: { __typename?: 'DeleteManyResponse'; deletedCount: number };
};
...
export type CreateManyUpworkJobsSearchCriteriaMutation = {
	__typename?: 'Mutation';
	createManyUpworkJobsSearchCriteria: Array<{ __typename?: 'UpworkJobsSearchCriterion'; id?: string | null }>;
};
...
export type JobPostsQuery = {
	...
	jobPosts: {
		...
		edges: Array<{
			__typename?: 'JobPostEdge';
			node: { __typename?: 'JobPost'; id?: string | null; isActive: boolean; isArchived: boolean };
		}>;
	};
};
...
export type TenantByExternalTenantIdQuery = {
	...
	tenants: {
		...
		edges: Array<{
			__typename?: 'TenantEdge';
			node: { __typename?: 'Tenant'; id?: string | null; name: string; externalTenantId?: string | null };
		}>;
	};
};

export const EmployeeJobPostsDocument = {
	kind: 'Document',
	definitions: [
		{
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'ConnectionCursor' } }
					}
				},
				{
					kind: 'VariableDefinition',
				...
				},
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'EmployeeJobPostFilter' } }
					}
				},
				{
					kind: 'VariableDefinition',
					...
					type: {
						...
						type: {
							kind: 'NonNullType',
							type: { kind: 'NamedType', name: { kind: 'Name', value: 'EmployeeJobPostSort' } }
						}
					}
				}
			],
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'isApplied' } },
														...
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'providerJobId' }
														},
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'jobDateCreated' }
														},
														{ kind: 'Field', name: { kind: 'Name', value: 'jobStatus' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'jobType' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'jobPostId' } },
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'jobPost' },
															selectionSet: {
																kind: 'SelectionSet',
																selections: [
																	{
																	...
																	{
																		kind: 'Field',
																		name: { kind: 'Name', value: 'clientFeedback' }
																	},
																	{
																		kind: 'Field',
																		name: {
																	...
																	{
																		kind: 'Field',
																		name: { kind: 'Name', value: 'clientPastHires' }
																	},
																	{
																		kind: 'Field',
																		name: {
...
} as unknown as DocumentNode<EmployeeJobPostsQuery, EmployeeJobPostsQueryVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'employeeIdFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				},
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'jobPostIdFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				}
			],
			selectionSet: {
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{
															kind: 'Field',
															name: { kind: 'Name', value: 'externalEmployeeId' }
														},
...
export const EmployeeByExternalEmployeeIdDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'externalEmployeeIdFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				}
			],
			selectionSet: {
												...
												fields: [
													{
														...
														value: {
															kind: 'Variable',
															name: { kind: 'Name', value: 'externalEmployeeIdFilter' }
														}
													}
												]
											}
...
} as unknown as DocumentNode<EmployeeByExternalEmployeeIdQuery, EmployeeByExternalEmployeeIdQueryVariables>;
export const EmployeeByNameDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'firstNameFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				},
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'lastNameFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				}
			],
			selectionSet: {
...
} as unknown as DocumentNode<EmployeeByNameQuery, EmployeeByNameQueryVariables>;
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateOneEmployeeInput' } }
					}
				}
			],
			selectionSet: {
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'externalEmployeeId' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'isActive' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'isArchived' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'firstName' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'lastName' } }
...
} as unknown as DocumentNode<UpdateOneEmployeeMutation, UpdateOneEmployeeMutationVariables>;
export const UpdateOneEmployeeJobPostDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateOneEmployeeJobPostInput' } }
					}
				}
			],
			selectionSet: {
...
} as unknown as DocumentNode<UpdateOneEmployeeJobPostMutation, UpdateOneEmployeeJobPostMutationVariables>;
export const DeleteManyUpworkJobsSearchCriteriaDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'DeleteManyUpworkJobsSearchCriteriaInput' }
						}
					}
				}
			],
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'Field', name: { kind: 'Name', value: 'deletedCount' } }]
						}
					}
				]
			}
...
>;
export const CreateManyUpworkJobsSearchCriteriaDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'CreateManyUpworkJobsSearchCriteriaInput' }
						}
					}
				}
			],
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'providerCodeFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				},
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'providerJobIdFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				}
			],
			selectionSet: {
...
} as unknown as DocumentNode<JobPostsQuery, JobPostsQueryVariables>;
export const TenantByExternalTenantIdDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'tenantByExternalTenantId' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'externalTenantFilter' } },
					type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } }
				}
			],
			selectionSet: {
						...
						arguments: [
							{
								...
								value: {
									...
									fields: [
										{
											kind: 'ObjectField',
											name: { kind: 'Name', value: 'externalTenantId' },
											value: {
												kind: 'ObjectValue',
												fields: [
													{
														...
														value: {
															kind: 'Variable',
															name: { kind: 'Name', value: 'externalTenantFilter' }
														}
													}
												]
											}
...
} as unknown as DocumentNode<TenantByExternalTenantIdQuery, TenantByExternalTenantIdQueryVariables>;
