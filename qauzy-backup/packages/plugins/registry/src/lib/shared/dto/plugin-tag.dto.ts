...
export class CreatePluginTagDTO
	extends IntersectionType(PartialType(TenantOrganizationBaseDTO))
 ...
 */
export class UpdatePluginTagDTO extends PartialType(CreatePluginTagDTO) implements IPluginTagUpdateInput {
	@ApiPropertyOptional({
		type: Number,
 ...
 */
export class ReplacePluginTagsDTO extends IntersectionType(PartialType(TenantOrganizationBaseDTO)) {
	@ApiProperty({
		type: [String],
