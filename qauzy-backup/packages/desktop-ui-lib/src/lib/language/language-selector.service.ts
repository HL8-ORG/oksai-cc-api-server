...
export class LanguageSelectorService {
	...
	constructor(
		...
		this._osLanguage = locale in LanguagesEnum ? locale : LanguagesEnum.ENGLISH;
	}

	public setLanguage(preferredLanguage: LanguagesEnum, translateService: TranslateService): void {
		if (preferredLanguage === LanguagesEnum.HEBREW || preferredLanguage === LanguagesEnum.ARABIC) {
