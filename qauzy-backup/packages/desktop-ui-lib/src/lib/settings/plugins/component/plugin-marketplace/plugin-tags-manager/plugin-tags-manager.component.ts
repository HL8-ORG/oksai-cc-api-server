...
export class PluginTagsManagerComponent implements OnInit, OnDestroy {
	...
	constructor(private readonly formBuilder: FormBuilder, private readonly dialogService: NbDialogService) {
		this.initializeForm();
	...
	private generateSmartSuggestions(): ITagSuggestion[] {
		...
		const keywordMappings = [
			{
				keywords: ['analytic', 'report', 'chart', 'graph', 'dashboard'],
				tag: 'analytics',
				reason: 'Analytics features detected'
			},
			...
			{ keywords: ['real-time', 'live', 'instant'], tag: 'real-time', reason: 'Real-time capabilities detected' },
			{
				...
				tag: 'mobile',
				reason: 'Mobile platform support detected'
			},
			{
				keywords: ['security', 'auth', 'encrypt', 'secure'],
				tag: 'security',
				reason: 'Security features detected'
			},
			{
				keywords: ['machine learning', 'ai', 'artificial intelligence', 'ml'],
				tag: 'machine-learning',
				reason: 'AI/ML features detected'
			},
