...
export class PluginInstallationActions {
	...
	public static downloadFailed = createAction(
		'[Plugin Installation] Download Failed',
		(error: string, pluginId?: string) => ({
			error,
			pluginId
		})
	);
	...
	public static installationFailed = createAction(
		'[Plugin Installation] Installation Failed',
		(error: string, pluginId?: string) => ({
			error,
			pluginId
		})
