...
// Deal related enums
const DealStatusEnum = z.enum(['LEAD', 'QUALIFIED_LEAD', 'PROPOSAL_MADE', 'NEGOTIATION', 'CLOSED_WON', 'CLOSED_LOST']);
...
// Activity log enums
const ActivityLogActionEnum = z.enum([
	'CREATED',
	'UPDATED',
	'DELETED',
	'VIEWED',
...
const ActivityLogEntityEnum = z.enum([
	'USER',
	'EMPLOYEE',
	'TASK',
	'PROJECT',
