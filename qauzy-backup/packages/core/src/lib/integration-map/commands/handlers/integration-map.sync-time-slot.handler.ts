...
export class IntegrationMapSyncTimeSlotHandler implements ICommandHandler<IntegrationMapSyncTimeSlotCommand> {
	constructor(
	 ...
	 * @returns
	 */
	public async execute(command: IntegrationMapSyncTimeSlotCommand) {
		const { input } = command;
