...
export const filterQuery = <T>(qb: SelectQueryBuilder<T>, wheres: ObjectLiteral) => {
	qb.andWhere(
...
export const objectQueryMapper = (query: WhereExpressionBuilder, value: ObjectLiteral, alias: string) => {
