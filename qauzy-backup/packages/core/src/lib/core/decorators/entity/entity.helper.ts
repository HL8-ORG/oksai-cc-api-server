 ...
 */
export const parseMikroOrmEntityOptions = ({
	mikroOrmRepository,
	...restOptions
}: MikroOrmEntityOptions<any>): Record<string, any> =>
	filterOptions({
 ...
 * @returns {Record<string, any>} - Parsed options.
 */
export const parseTypeOrmEntityOptions = ({
	typeOrmRepository,
	...restOptions
}: TypeOrmEntityOptions): Record<string, any> =>
	filterOptions({
 ...
 */
export const filterOptions = <T>(options: T): Record<string, any> =>
