...
export class OrganizationTeamJoinRequestCreateHandler
	implements ICommandHandler<OrganizationTeamJoinRequestCreateCommand>
{
	constructor(private readonly _organizationTeamJoinRequestService: OrganizationTeamJoinRequestService) {}

	public async execute(command: OrganizationTeamJoinRequestCreateCommand): Promise<Object> {
		try {
