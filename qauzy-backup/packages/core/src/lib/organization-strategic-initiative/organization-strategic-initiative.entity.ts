...
@MultiORMEntity('organization_strategic_initiative', {
	mikroOrmRepository: () => MikroOrmOrganizationStrategicInitiativeRepository
})
export class OrganizationStrategicInitiative
	extends TenantOrganizationBaseEntity
	implements IOrganizationStrategicInitiative
{
