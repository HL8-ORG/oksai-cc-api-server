...
import { IOrganization, ITenant, RecurringExpenseDefaultCategoriesEnum } from '@gauzy/contracts';
...
export const createDefaultOrganizationRecurringExpense = async (
	...
	const expenseCategories = Object.keys(RecurringExpenseDefaultCategoriesEnum);
