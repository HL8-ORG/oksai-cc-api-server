...
export class OrganizationRecurringExpenseUpdateTypeHandler
	...
	implements IQueryHandler<OrganizationRecurringExpenseStartDateUpdateTypeQuery>
{
	...
	public async execute(command: OrganizationRecurringExpenseStartDateUpdateTypeQuery): Promise<IStartUpdateTypeInfo> {
