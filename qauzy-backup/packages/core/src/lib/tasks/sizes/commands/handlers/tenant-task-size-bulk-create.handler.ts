...
export class TenantTaskSizeBulkCreateHandler implements ICommandHandler<TenantTaskSizeBulkCreateCommand> {
	constructor(private readonly taskSizeService: TaskSizeService) {}
