...
export const createRandomTenants = async (dataSource: DataSource, noOfTenants: number = 0): Promise<Tenant[]> => {
...
const insertTenants = async (dataSource: DataSource, tenants: Tenant[]): Promise<Tenant[]> => {
