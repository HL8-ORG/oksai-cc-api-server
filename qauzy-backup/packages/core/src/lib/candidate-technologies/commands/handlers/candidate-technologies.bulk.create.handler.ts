...
export class CandidateTechnologiesBulkCreateHandler implements ICommandHandler<CandidateTechnologiesBulkCreateCommand> {
	constructor(private readonly candidateTechnologiesService: CandidateTechnologiesService) {}

	public async execute(command: CandidateTechnologiesBulkCreateCommand): Promise<CandidateTechnologies[]> {
