...
export class CandidateTechnologiesBulkUpdateHandler implements ICommandHandler<CandidateTechnologiesBulkUpdateCommand> {
	constructor(private readonly candidateTechnologiesService: CandidateTechnologiesService) {}

	public async execute(command: CandidateTechnologiesBulkUpdateCommand): Promise<any> {
