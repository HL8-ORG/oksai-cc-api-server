...
export class CreateSharedEntityTable1766238538367 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "shared_entity" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "entity" character varying NOT NULL, "entityId" character varying NOT NULL, "token" character varying NOT NULL, "shareRules" jsonb NOT NULL, "sharedOptions" jsonb, CONSTRAINT "PK_44a2e8c95ee195f69dd609e047c" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_06ea1a5c01e60e4531cc01282b" ON "shared_entity" ("createdByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_9fcac8f30b4e1667ec54636bc0" ON "shared_entity" ("updatedByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_08aabe353224b3f7a2c7e155e1" ON "shared_entity" ("deletedByUserId") `
		);
		...
		await queryRunner.query(
			`ALTER TABLE "shared_entity" ADD CONSTRAINT "FK_06ea1a5c01e60e4531cc01282b5" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "shared_entity" ADD CONSTRAINT "FK_9fcac8f30b4e1667ec54636bc01" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "shared_entity" ADD CONSTRAINT "FK_08aabe353224b3f7a2c7e155e14" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "shared_entity" ADD CONSTRAINT "FK_16c97b224c3592dd589f0dff381" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "shared_entity" ADD CONSTRAINT "FK_87232c0df1129aaee40a1de44a2" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
	}
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "shared_entity" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "entity" varchar NOT NULL, "entityId" varchar NOT NULL, "token" varchar NOT NULL, "shareRules" text NOT NULL, "sharedOptions" text)`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_06ea1a5c01e60e4531cc01282b" ON "shared_entity" ("createdByUserId") `
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`INSERT INTO "shared_entity"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "entity", "entityId", "token", "shareRules", "sharedOptions") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "entity", "entityId", "token", "shareRules", "sharedOptions" FROM "temporary_shared_entity"`
		);
