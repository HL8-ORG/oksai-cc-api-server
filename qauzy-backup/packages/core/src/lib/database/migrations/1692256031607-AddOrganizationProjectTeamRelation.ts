...
export class AddOrganizationProjectTeamRelation1692256031607 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "organization_project_team" ("organizationProjectId" uuid NOT NULL, "organizationTeamId" uuid NOT NULL, CONSTRAINT "PK_a9a3f212a3e0e2f5e6dba06edd0" PRIMARY KEY ("organizationProjectId", "organizationTeamId"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_7c31431ff2173c2c939a0aa036" ON "organization_project_team" ("organizationProjectId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_599a5f7f6c190822dcfdbbb6eb" ON "organization_project_team" ("organizationTeamId") `
		);
		await queryRunner.query(
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`ALTER TABLE "organization_project_team" DROP CONSTRAINT "FK_599a5f7f6c190822dcfdbbb6eb0"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_team" DROP CONSTRAINT "FK_7c31431ff2173c2c939a0aa036c"`
		);
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "organization_project_team" ("organizationProjectId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("organizationProjectId", "organizationTeamId"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_7c31431ff2173c2c939a0aa036" ON "organization_project_team" ("organizationProjectId") `
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_7c31431ff2173c2c939a0aa036"`);
		await queryRunner.query(
			`ALTER TABLE "organization_project_team" RENAME TO "temporary_organization_project_team"`
		);
		await queryRunner.query(
			`CREATE TABLE "organization_project_team" ("organizationProjectId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("organizationProjectId", "organizationTeamId"))`
		);
		await queryRunner.query(
			`INSERT INTO "organization_project_team"("organizationProjectId", "organizationTeamId") SELECT "organizationProjectId", "organizationTeamId" FROM "temporary_organization_project_team"`
		);
