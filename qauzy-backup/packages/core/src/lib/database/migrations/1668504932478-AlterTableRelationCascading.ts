...
export class AlterTableRelationCascading1668504932478 implements MigrationInterface {
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_skill_employee" ("skillId" varchar NOT NULL, "employeeId" varchar NOT NULL, CONSTRAINT "FK_760034f54e598d519b5f0c4ecee" FOREIGN KEY ("employeeId") REFERENCES "employee" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("skillId", "employeeId"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_skill_organization" ("skillId" varchar NOT NULL, "organizationId" varchar NOT NULL, CONSTRAINT "FK_b65cfda00c52e1fc26cc96e52ca" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("skillId", "organizationId"))`
		);
		await queryRunner.query(
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "skill_organization" ("skillId" varchar NOT NULL, "organizationId" varchar NOT NULL, CONSTRAINT "FK_b65cfda00c52e1fc26cc96e52ca" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("skillId", "organizationId"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "skill_employee" ("skillId" varchar NOT NULL, "employeeId" varchar NOT NULL, CONSTRAINT "FK_760034f54e598d519b5f0c4ecee" FOREIGN KEY ("employeeId") REFERENCES "employee" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("skillId", "employeeId"))`
		);
		await queryRunner.query(
