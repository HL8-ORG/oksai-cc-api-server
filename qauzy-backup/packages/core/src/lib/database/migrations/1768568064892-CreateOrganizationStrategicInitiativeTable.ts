...
export class CreateOrganizationStrategicInitiativeTable1768568064892 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "organization_strategic_initiative" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "title" character varying NOT NULL, "intent" text, "state" character varying NOT NULL DEFAULT 'draft', "visibilityScope" character varying NOT NULL DEFAULT 'organization', "signals" jsonb, "stewardId" uuid, CONSTRAINT "PK_5c9b922c6ef3ea031a5ce6a3e39" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_373d5b9de4985dcef9594cbb1d" ON "organization_strategic_initiative" ("createdByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_12dc5eb57d914441d4e5ce0a9d" ON "organization_strategic_initiative" ("updatedByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_4d666b2fd258582fcdfcec5106" ON "organization_strategic_initiative" ("deletedByUserId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_8086ec128fa803de402b3f7140" ON "organization_strategic_initiative" ("isActive") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_36f130eca2a6e6dfc439339740" ON "organization_strategic_initiative" ("isArchived") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_86462fa56f1f7c8ddf1421dcf1" ON "organization_strategic_initiative" ("tenantId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_2e818b78a0c614ace2902632fc" ON "organization_strategic_initiative" ("organizationId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_ae3bf84067ac6f5510d9513fad" ON "organization_strategic_initiative" ("title") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_48ff35a700f121a16a30d8627b" ON "organization_strategic_initiative" ("state") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_45067e1433883ad9f44354a7ea" ON "organization_strategic_initiative" ("visibilityScope") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_73711137bbfaa40659696deabb" ON "organization_strategic_initiative" ("stewardId") `
		);
		await queryRunner.query(
			`CREATE TABLE "organization_project_organization_strategic_initiative" ("organizationProjectId" uuid NOT NULL, "organizationStrategicInitiativeId" uuid NOT NULL, CONSTRAINT "PK_a0e5225bd18ede0b0bad3f3f61b" PRIMARY KEY ("organizationProjectId", "organizationStrategicInitiativeId"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_aadcf9f5b3a05bd6c16e2bef80" ON "organization_project_organization_strategic_initiative" ("organizationProjectId") `
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_39df82db57fb1d0efff351adc4" ON "organization_project_organization_strategic_initiative" ("organizationStrategicInitiativeId") `
		);
		await queryRunner.query(`ALTER TABLE "goal" ADD "organizationStrategicInitiativeId" uuid`);
		await queryRunner.query(
			`CREATE INDEX "IDX_8a9c7aade035b947e6c7a76a2b" ON "goal" ("organizationStrategicInitiativeId") `
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_373d5b9de4985dcef9594cbb1d1" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_12dc5eb57d914441d4e5ce0a9d7" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_4d666b2fd258582fcdfcec51064" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_86462fa56f1f7c8ddf1421dcf17" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_2e818b78a0c614ace2902632fcd" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" ADD CONSTRAINT "FK_73711137bbfaa40659696deabbd" FOREIGN KEY ("stewardId") REFERENCES "employee"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "goal" ADD CONSTRAINT "FK_8a9c7aade035b947e6c7a76a2bc" FOREIGN KEY ("organizationStrategicInitiativeId") REFERENCES "organization_strategic_initiative"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_organization_strategic_initiative" ADD CONSTRAINT "FK_aadcf9f5b3a05bd6c16e2bef806" FOREIGN KEY ("organizationProjectId") REFERENCES "organization_project"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_organization_strategic_initiative" ADD CONSTRAINT "FK_39df82db57fb1d0efff351adc4f" FOREIGN KEY ("organizationStrategicInitiativeId") REFERENCES "organization_strategic_initiative"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
	}
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`ALTER TABLE "organization_project_organization_strategic_initiative" DROP CONSTRAINT "FK_39df82db57fb1d0efff351adc4f"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_project_organization_strategic_initiative" DROP CONSTRAINT "FK_aadcf9f5b3a05bd6c16e2bef806"`
		);
		await queryRunner.query(`ALTER TABLE "goal" DROP CONSTRAINT "FK_8a9c7aade035b947e6c7a76a2bc"`);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_73711137bbfaa40659696deabbd"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_2e818b78a0c614ace2902632fcd"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_86462fa56f1f7c8ddf1421dcf17"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_4d666b2fd258582fcdfcec51064"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_12dc5eb57d914441d4e5ce0a9d7"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_strategic_initiative" DROP CONSTRAINT "FK_373d5b9de4985dcef9594cbb1d1"`
		);
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "organization_project_organization_strategic_initiative" ("organizationProjectId" varchar NOT NULL, "organizationStrategicInitiativeId" varchar NOT NULL, PRIMARY KEY ("organizationProjectId", "organizationStrategicInitiativeId"))`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_aadcf9f5b3a05bd6c16e2bef80" ON "organization_project_organization_strategic_initiative" ("organizationProjectId") `
		);
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_organization_project_organization_strategic_initiative" ("organizationProjectId" varchar NOT NULL, "organizationStrategicInitiativeId" varchar NOT NULL, CONSTRAINT "FK_aadcf9f5b3a05bd6c16e2bef806" FOREIGN KEY ("organizationProjectId") REFERENCES "organization_project" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_39df82db57fb1d0efff351adc4f" FOREIGN KEY ("organizationStrategicInitiativeId") REFERENCES "organization_strategic_initiative" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("organizationProjectId", "organizationStrategicInitiativeId"))`
		);
		await queryRunner.query(
			`INSERT INTO "temporary_organization_project_organization_strategic_initiative"("organizationProjectId", "organizationStrategicInitiativeId") SELECT "organizationProjectId", "organizationStrategicInitiativeId" FROM "organization_project_organization_strategic_initiative"`
		);
		await queryRunner.query(`DROP TABLE "organization_project_organization_strategic_initiative"`);
		await queryRunner.query(
			`ALTER TABLE "temporary_organization_project_organization_strategic_initiative" RENAME TO "organization_project_organization_strategic_initiative"`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_aadcf9f5b3a05bd6c16e2bef80" ON "organization_project_organization_strategic_initiative" ("organizationProjectId") `
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`DROP INDEX "IDX_aadcf9f5b3a05bd6c16e2bef80"`);
		await queryRunner.query(
			`ALTER TABLE "organization_project_organization_strategic_initiative" RENAME TO "temporary_organization_project_organization_strategic_initiative"`
		);
		await queryRunner.query(
			`CREATE TABLE "organization_project_organization_strategic_initiative" ("organizationProjectId" varchar NOT NULL, "organizationStrategicInitiativeId" varchar NOT NULL, PRIMARY KEY ("organizationProjectId", "organizationStrategicInitiativeId"))`
		);
		await queryRunner.query(
			`INSERT INTO "organization_project_organization_strategic_initiative"("organizationProjectId", "organizationStrategicInitiativeId") SELECT "organizationProjectId", "organizationStrategicInitiativeId" FROM "temporary_organization_project_organization_strategic_initiative"`
		);
	...
	public async mysqlDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`ALTER TABLE \`organization_project_organization_strategic_initiative\` DROP FOREIGN KEY \`FK_39df82db57fb1d0efff351adc4f\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_project_organization_strategic_initiative\` DROP FOREIGN KEY \`FK_aadcf9f5b3a05bd6c16e2bef806\``
		);
		await queryRunner.query(`ALTER TABLE \`goal\` DROP FOREIGN KEY \`FK_8a9c7aade035b947e6c7a76a2bc\``);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_73711137bbfaa40659696deabbd\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_2e818b78a0c614ace2902632fcd\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_86462fa56f1f7c8ddf1421dcf17\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_4d666b2fd258582fcdfcec51064\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_12dc5eb57d914441d4e5ce0a9d7\``
		);
		await queryRunner.query(
			`ALTER TABLE \`organization_strategic_initiative\` DROP FOREIGN KEY \`FK_373d5b9de4985dcef9594cbb1d1\``
		);
		await queryRunner.query(`DROP INDEX \`IDX_8a9c7aade035b947e6c7a76a2b\` ON \`goal\``);
		await queryRunner.query(`ALTER TABLE \`goal\` DROP COLUMN \`organizationStrategicInitiativeId\``);
		await queryRunner.query(
			`DROP INDEX \`IDX_39df82db57fb1d0efff351adc4\` ON \`organization_project_organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_aadcf9f5b3a05bd6c16e2bef80\` ON \`organization_project_organization_strategic_initiative\``
		);
		await queryRunner.query(`DROP TABLE \`organization_project_organization_strategic_initiative\``);
		await queryRunner.query(
			`DROP INDEX \`IDX_73711137bbfaa40659696deabb\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_45067e1433883ad9f44354a7ea\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_48ff35a700f121a16a30d8627b\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_ae3bf84067ac6f5510d9513fad\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_2e818b78a0c614ace2902632fc\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_86462fa56f1f7c8ddf1421dcf1\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_36f130eca2a6e6dfc439339740\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_8086ec128fa803de402b3f7140\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_4d666b2fd258582fcdfcec5106\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_12dc5eb57d914441d4e5ce0a9d\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(
			`DROP INDEX \`IDX_373d5b9de4985dcef9594cbb1d\` ON \`organization_strategic_initiative\``
		);
		await queryRunner.query(`DROP TABLE \`organization_strategic_initiative\``);
	}
}
