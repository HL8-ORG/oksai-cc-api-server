...
export class CreateIntegrationOrganizationGithubRepositoryTable1697716380119 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE "organization_project" RENAME COLUMN "externalRepositoryId" TO "repositoryId"`
		);
		await queryRunner.query(
			`CREATE TABLE "organization_github_repository" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "tenantId" uuid, "organizationId" uuid, "repositoryId" integer NOT NULL, "name" character varying NOT NULL, "fullName" character varying NOT NULL, "owner" character varying NOT NULL, "integrationId" uuid, CONSTRAINT "PK_7aa9f2bb334f439e229b0aadbfa" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE "organization_github_repository" DROP CONSTRAINT "FK_add7dbec156589dd0b27e2e0c49"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_github_repository" DROP CONSTRAINT "FK_69d75a47af6bfcda545a865691b"`
		);
		await queryRunner.query(
			`ALTER TABLE "organization_github_repository" DROP CONSTRAINT "FK_480158f21938444e4f62fb31857"`
		);
		...
		await queryRunner.query(
			`ALTER TABLE "organization_project" RENAME COLUMN "repositoryId" TO "externalRepositoryId"`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_60f6ebb4ab539087ce5f4266ca" ON "organization_project" ("externalRepositoryId") `
		);
	}
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "organization_github_repository" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "repositoryId" integer NOT NULL, "name" varchar NOT NULL, "fullName" varchar NOT NULL, "owner" varchar NOT NULL, "integrationId" varchar)`
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_5e97728cfda96f49cc7f95bbaf" ON "organization_github_repository" ("isActive") `
		);
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_organization_github_repository" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "repositoryId" integer NOT NULL, "name" varchar NOT NULL, "fullName" varchar NOT NULL, "owner" varchar NOT NULL, "integrationId" varchar, CONSTRAINT "FK_480158f21938444e4f62fb31857" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_69d75a47af6bfcda545a865691b" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_add7dbec156589dd0b27e2e0c49" FOREIGN KEY ("integrationId") REFERENCES "integration_tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
		);
		await queryRunner.query(
