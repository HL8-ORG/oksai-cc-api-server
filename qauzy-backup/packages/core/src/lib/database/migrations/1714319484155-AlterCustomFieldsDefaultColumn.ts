...
export class AlterCustomFieldsDefaultColumn1714319484155 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE "employee" RENAME COLUMN "__fix_relational_custom_fields__" TO "fix_relational_custom_fields"`
		);
		await queryRunner.query(
			`ALTER TABLE "tag" RENAME COLUMN "__fix_relational_custom_fields__" TO "fix_relational_custom_fields"`
		);
		await queryRunner.query(
			`ALTER TABLE "employee_job_preset" ADD CONSTRAINT "FK_68e75e49f06409fd385b4f87746" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "tag_proposal" ADD CONSTRAINT "FK_451853704de278eef61a37fa7a6" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
	}
	...
	public async postgresDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(`ALTER TABLE "employee_job_preset" DROP CONSTRAINT "FK_68e75e49f06409fd385b4f87746"`);
		await queryRunner.query(
			`ALTER TABLE "tag" RENAME COLUMN "fix_relational_custom_fields" TO "__fix_relational_custom_fields__"`
		);
		await queryRunner.query(
			`ALTER TABLE "employee" RENAME COLUMN "fix_relational_custom_fields" TO "__fix_relational_custom_fields__"`
		);
		await queryRunner.query(
			`ALTER TABLE "tag_proposal" ADD CONSTRAINT "FK_451853704de278eef61a37fa7a6" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		await queryRunner.query(
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_employee_job_preset" ("jobPresetId" varchar NOT NULL, "employeeId" varchar NOT NULL, PRIMARY KEY ("jobPresetId", "employeeId"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_tag_proposal" ("proposalId" varchar NOT NULL, "tagId" varchar NOT NULL, CONSTRAINT "FK_3f55851a03524e567594d507744" FOREIGN KEY ("proposalId") REFERENCES "proposal" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("proposalId", "tagId"))`
		);
		await queryRunner.query(
			`INSERT INTO "temporary_tag_proposal"("proposalId", "tagId") SELECT "proposalId", "tagId" FROM "tag_proposal"`
		);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TABLE "tag_proposal" ("proposalId" varchar NOT NULL, "tagId" varchar NOT NULL, CONSTRAINT "FK_3f55851a03524e567594d507744" FOREIGN KEY ("proposalId") REFERENCES "proposal" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("proposalId", "tagId"))`
		);
		await queryRunner.query(
			`INSERT INTO "tag_proposal"("proposalId", "tagId") SELECT "proposalId", "tagId" FROM "temporary_tag_proposal"`
		);
		...
		await queryRunner.query(
			`CREATE TABLE "employee_job_preset" ("jobPresetId" varchar NOT NULL, "employeeId" varchar NOT NULL, PRIMARY KEY ("jobPresetId", "employeeId"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(`ALTER TABLE "employee_job_preset" RENAME TO "temporary_employee_job_preset"`);
		await queryRunner.query(
			`CREATE TABLE "employee_job_preset" ("jobPresetId" varchar NOT NULL, "employeeId" varchar NOT NULL, CONSTRAINT "FK_68e75e49f06409fd385b4f87746" FOREIGN KEY ("employeeId") REFERENCES "employee" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_7ae5b4d4bdec77971dab319f2e2" FOREIGN KEY ("jobPresetId") REFERENCES "job_preset" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("jobPresetId", "employeeId"))`
		);
		await queryRunner.query(
			`INSERT INTO "employee_job_preset"("jobPresetId", "employeeId") SELECT "jobPresetId", "employeeId" FROM "temporary_employee_job_preset"`
		);
	...
	public async mysqlUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE \`employee\` CHANGE \`__fix_relational_custom_fields__\` \`fix_relational_custom_fields\` tinyint NULL`
		);
		await queryRunner.query(
			`ALTER TABLE \`tag\` CHANGE \`__fix_relational_custom_fields__\` \`fix_relational_custom_fields\` tinyint NULL`
		);
		await queryRunner.query(
			`ALTER TABLE \`employee_job_preset\` ADD CONSTRAINT \`FK_68e75e49f06409fd385b4f87746\` FOREIGN KEY (\`employeeId\`) REFERENCES \`employee\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`
		);
	...
	public async mysqlDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`ALTER TABLE \`tag\` CHANGE \`fix_relational_custom_fields\` \`__fix_relational_custom_fields__\` tinyint NULL`
		);
		await queryRunner.query(
			`ALTER TABLE \`employee\` CHANGE \`fix_relational_custom_fields\` \`__fix_relational_custom_fields__\` tinyint NULL`
		);
		await queryRunner.query(
			`ALTER TABLE \`tag_proposal\` ADD CONSTRAINT \`FK_451853704de278eef61a37fa7a6\` FOREIGN KEY (\`tagId\`) REFERENCES \`tag\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
