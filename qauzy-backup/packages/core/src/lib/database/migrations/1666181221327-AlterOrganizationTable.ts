...
export class AlterOrganizationTable1666181221327 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`CREATE TYPE "public"."organization_defaultvaluedatetype_enum" AS ENUM('TODAY', 'END_OF_MONTH', 'START_OF_MONTH')`
		);
		await queryRunner.query(
			`ALTER TABLE "organization" ADD "defaultValueDateType" "public"."organization_defaultvaluedatetype_enum" DEFAULT 'TODAY'`
		);
		await queryRunner.query(
