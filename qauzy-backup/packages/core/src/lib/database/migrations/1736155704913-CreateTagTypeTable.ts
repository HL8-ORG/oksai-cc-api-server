...
export class CreateTagTypeTable1736155704913 implements MigrationInterface {
	...
	public async postgresUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "tag_type" ("deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "type" character varying NOT NULL, CONSTRAINT "PK_0829ee814cd10d5a337eaa07443" PRIMARY KEY ("id"))`
		);
		...
		await queryRunner.query(
			`ALTER TABLE "tag" ADD CONSTRAINT "FK_1c84215eb01fa457d0beeaee7fc" FOREIGN KEY ("tagTypeId") REFERENCES "tag_type"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "tag_type" ADD CONSTRAINT "FK_556112dc97b482454726198f250" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
		);
		await queryRunner.query(
			`ALTER TABLE "tag_type" ADD CONSTRAINT "FK_dcefa726d2f515583535cb540f3" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`
		);
	}
	...
	public async sqliteUpQueryRunner(queryRunner: QueryRunner): Promise<any> {
		await queryRunner.query(
			`CREATE TABLE "tag_type" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "type" varchar NOT NULL)`
		);
		await queryRunner.query(`CREATE INDEX "IDX_c1bef0b8aa28d47b9907667a1f" ON "tag_type" ("isActive") `);
		await queryRunner.query(`CREATE INDEX "IDX_e2d517d3e3ff2a873f43367813" ON "tag_type" ("isArchived") `);
		await queryRunner.query(`CREATE INDEX "IDX_556112dc97b482454726198f25" ON "tag_type" ("tenantId") `);
		...
		await queryRunner.query(
			`CREATE TABLE "temporary_tag_type" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "type" varchar NOT NULL, CONSTRAINT "FK_556112dc97b482454726198f250" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_dcefa726d2f515583535cb540f3" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`
		);
		await queryRunner.query(
			`INSERT INTO "temporary_tag_type"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type" FROM "tag_type"`
		);
		await queryRunner.query(`DROP TABLE "tag_type"`);
	...
	public async sqliteDownQueryRunner(queryRunner: QueryRunner): Promise<any> {
		...
		await queryRunner.query(
			`INSERT INTO "tag_type"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type" FROM "temporary_tag_type"`
		);
