...
export class AvailabilitySlotsCreateHandler implements ICommandHandler<AvailabilitySlotsCreateCommand> {
	constructor(
		private readonly availabilitySlotsService: AvailabilitySlotsService,
		private readonly commandBus: CommandBus
	) {}

	public async execute(command: AvailabilitySlotsCreateCommand): Promise<IAvailabilitySlot> {
