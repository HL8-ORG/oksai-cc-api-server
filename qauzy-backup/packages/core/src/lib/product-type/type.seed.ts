...
const insertProductTypes = async (dataSource: DataSource, productTypes: ProductType[]): Promise<ProductType[]> => {
...
const generateProductType = async (tenant: ITenant, organization: IOrganization): Promise<ProductType[]> => {
