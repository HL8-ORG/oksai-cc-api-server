...
export class InvoicePaymentGeneratePdfHandler implements ICommandHandler<InvoicePaymentGeneratePdfCommand> {
	constructor(private readonly invoiceService: InvoiceService) {}

	public async execute(command: InvoicePaymentGeneratePdfCommand): Promise<Buffer> {
