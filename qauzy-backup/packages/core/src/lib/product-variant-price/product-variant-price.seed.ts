			...
			for (const productCategory of productCategories) {
				...
				for (const product of products) {
					...
					for (const productVariant of productVariants) {
						...
						productVariantPrice.unitCost = faker.number.int(10000);
						productVariantPrice.unitCostCurrency = tenantOrg.currency || env.defaultCurrency;
						productVariantPrice.retailPrice = faker.number.int(productVariantPrice.unitCost);
						productVariantPrice.retailPriceCurrency = tenantOrg.currency || env.defaultCurrency;
