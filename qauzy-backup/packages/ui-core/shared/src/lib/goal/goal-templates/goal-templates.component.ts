...
import { KeyResultDeadlineEnum, GoalLevelEnum, KeyResultTypeEnum, KeyResultNumberUnitsEnum } from '@gauzy/contracts';
...
export class GoalTemplatesComponent implements OnInit {
	...
	constructor(private fb: UntypedFormBuilder, private dialogRef: NbDialogRef<GoalTemplatesComponent>) {}
