...
export class FeatureStoreService {
	...
	private _featureOrganizations$: BehaviorSubject<IFeatureOrganization[]> = new BehaviorSubject([]);
	public featureOrganizations$: Observable<IFeatureOrganization[]> = this._featureOrganizations$.asObservable();
	...
	public loadFeatures(relations?: string[]): Observable<IPagination<IFeature>> {
