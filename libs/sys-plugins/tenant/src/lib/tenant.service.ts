...
export class TenantService {
	...
	async update(id: string, updateTenantDto: UpdateTenantDto): Promise<Tenant> {
		...
		if (updateTenantDto.contactPhone !== undefined) {
		...
		if (updateTenantDto.city !== undefined) {
		...
		if (updateTenantDto.locale !== undefined) {
			tenant.locale = updateTenantDto.locale;
		}

		if (updateTenantDto.timezone !== undefined) {
			tenant.timezone = updateTenantDto.timezone;
		}
